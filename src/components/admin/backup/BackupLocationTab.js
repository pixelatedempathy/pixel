...
var BackupLocationTab = function () {
              ...
              return (
                <tr key={location.id}>
                  ...
                  <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-500 dark:text-gray-300">
                    ...
                    {location.type === 's3' && 's3://'.concat(location.bucket)}
                    {location.type === 'azure' &&
                      'Azure: '.concat(location.bucket)}
                    {location.type === 'gcp' && 'GCS: '.concat(location.bucket)}
                  </td>
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="flex justify-end space-x-3">
              ...
              <button
                ...
                className={'inline-flex items-center px-4 py-2 border border-transparent shadow-sm text-sm font-medium rounded-md text-white '.concat(
                  isFormLoading
                    ? 'bg-gray-400'
...
exports.default = BackupLocationTab
