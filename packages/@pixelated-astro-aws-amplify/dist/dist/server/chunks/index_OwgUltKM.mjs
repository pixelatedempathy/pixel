;!function(){try{var e="undefined"!=typeof window?window:"undefined"!=typeof global?global:"undefined"!=typeof globalThis?globalThis:"undefined"!=typeof self?self:{},n=(new e.Error).stack;n&&(e._sentryDebugIds=e._sentryDebugIds||{},e._sentryDebugIds[n]="0d0ca48f-802c-47b0-a44a-1e3f43402476",e._sentryDebugIdIdentifier="sentry-dbid-0d0ca48f-802c-47b0-a44a-1e3f43402476")}catch(e){}}();import { a as getHipaaCompliantLogger, c as getClinicalAnalysisLogger, d as getAiServiceLogger } from './standardized-logger_CFC_ud1c.mjs';
import { config, getEnv } from './env.config_Cpl4OEkp.mjs';
...
class MentalLLaMAAdapter {
  ...
  constructor(options) {
    ...
    try {
      this.crisisSessionFlaggingServiceImport = import('./CrisisSessionFlaggingService_DhVlryWA.mjs');
    } catch (_e) {
      logger$2.warn(
...
async function createMentalLLaMAPythonBridge(scriptPath) {
  if (typeof process !== "undefined" && process.versions?.node && typeof window === "undefined") {
    try {
      ...
      const { MentalLLaMAPythonBridge } = await import('./browser-stub_DcBcBpfA.mjs');
