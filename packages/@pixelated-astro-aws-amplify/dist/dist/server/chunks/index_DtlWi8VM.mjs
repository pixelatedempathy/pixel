...
import { l as logAuditEvent, A as AuditEventType } from './audit_CMoAMAaW.mjs';
import { d as dlpService } from './dlp_cDJ5EReX.mjs';
import { R as RecoveryTestStatus, S as StorageLocation, B as BackupType, a as BackupStatus } from './backup-types_Cb1FnCkU.mjs';
...
async function getStorageProvider(provider, config = {}) {
  try {
    const { getStorageProvider: importedGetStorageProvider } = await import('./storage-providers-wrapper_x8ars0Nw.mjs');
