;!function(){try{var e="undefined"!=typeof window?window:"undefined"!=typeof global?global:"undefined"!=typeof globalThis?globalThis:"undefined"!=typeof self?self:{},n=(new e.Error).stack;n&&(e._sentryDebugIds=e._sentryDebugIds||{},e._sentryDebugIds[n]="0c632fdd-6d9d-4bb6-b616-e4fc84bcb3f0",e._sentryDebugIdIdentifier="sentry-dbid-0c632fdd-6d9d-4bb6-b616-e4fc84bcb3f0")}catch(e){}}();import { o as AstroError, at as UnknownContentCollectionError, c as createComponent, au as RenderUndefinedEntryError, ar as unescapeHTML, a as renderTemplate, q as escape, av as renderUniqueStylesheet, aw as renderScriptElement, ax as createHeadAndContent, r as renderComponent } from './astro/server_t-wqd6mp.mjs';
import { z } from 'zod';
...
class ImmutableDataStore {
  ...
  static async fromModule() {
    try {
      const data = await import('./_astro_data-layer-content_-Nect3iK.mjs');
...
function createGetCollection({
  ...
  return async function getCollection(collection, filter) {
    ...
    if (collection in contentCollectionToEntryMap) {
      ...
      const { default: imageAssetMap } = await import('./content-assets_BHsJ5hNm.mjs');
      const result = [];
...
async function updateImageReferencesInBody(html, fileName) {
  ...
  const { getImage } = await import('./_astro_assets_Cs76h3vR.mjs').then(n => n._);
...
async function renderEntry(entry) {
  ...
  if (entry.deferredRender) {
    try {
      const { default: contentModules } = await import('./content-modules_BhIpyahH.mjs');
