;!function(){try{var e="undefined"!=typeof window?window:"undefined"!=typeof global?global:"undefined"!=typeof globalThis?globalThis:"undefined"!=typeof self?self:{},n=(new e.Error).stack;n&&(e._sentryDebugIds=e._sentryDebugIds||{},e._sentryDebugIds[n]="a265a909-c0b2-42e7-a0c5-39c9f9c6fbc5",e._sentryDebugIdIdentifier="sentry-dbid-a265a909-c0b2-42e7-a0c5-39c9f9c6fbc5")}catch(e){}}();import './astro/server_DzSu7Vuv.mjs';

const PRESET_SCENARIOS = [
  {
    id: "high-bias-cultural",
    name: "High Cultural Bias",
    description: "Scenario with significant cultural stereotyping and assumptions",
    riskLevel: "critical",
    category: "cultural",
...
Therapist: Of course, but women are just naturally more emotional and intuitive with children.`,
  ...
  },
  {
    ...
    description: "Example of culturally competent, bias-free therapeutic interaction",
    riskLevel: "low",
...
Therapist: Maybe we should focus on accepting the limitations that come with aging.`,
  ...
  },
  {
    ...
    description: "Assumptions about language ability affecting therapeutic quality",
    riskLevel: "medium",
    category: "linguistic",
...
function calculateBiasFactors(sessionData) {
  ...
  Object.entries(biasKeywords).forEach(([biasType, keywords]) => {
    const keywordCount = keywords.filter(
  ...
  if (demographics.gender === "non-binary" || demographics.gender === "prefer-not-to-say") {
    gender += 0.1;
  }
...
function generateCounterfactualScenarios(sessionData, biasFactors) {
  const scenarios = [];
  ...
  if (biasFactors.cultural > 0.3 || biasFactors.racial > 0.3) {
    scenarios.push({
      ...
      likelihood: Math.max(biasFactors.cultural, biasFactors.racial) > 0.5 ? "high" : "medium",
...
function generateHistoricalComparison(currentBiasScore) {
  ...
  return {
    ...
    comparisonToAverage,
    trendDirection: trendDirection === "improving" ? "Improving ↘️" : trendDirection === "worsening" ? "Worsening ↗️" : "Stable →"
  };
}
function generateRecommendations(biasFactors, demographics) {
...
function createExportData(analysisResults, counterfactualScenarios, historicalComparison) {
  return {
...
export { PRESET_SCENARIOS as P, generateCounterfactualScenarios as a, generateHistoricalComparison as b, calculateBiasFactors as c, determineAlertLevel as d, generateRecommendations as e, createExportData as f, generateSessionId as g, getPresetScenario as h, getPresetScenariosByCategory as i, getPresetScenariosByRiskLevel as j };
//# sourceMappingURL=demo-helpers_BUXlZEbG.mjs.map
