;!function(){try{var e="undefined"!=typeof window?window:"undefined"!=typeof global?global:"undefined"!=typeof globalThis?globalThis:"undefined"!=typeof self?self:{},n=(new e.Error).stack;n&&(e._sentryDebugIds=e._sentryDebugIds||{},e._sentryDebugIds[n]="73e26381-b14a-4dd8-b949-dfd728941ec2",e._sentryDebugIdIdentifier="sentry-dbid-73e26381-b14a-4dd8-b949-dfd728941ec2")}catch(e){}}();import { jsxs, jsx } from 'react/jsx-runtime';
import { useId, useState, useRef, useEffect } from 'react';
import { C as Card, a as CardHeader, b as CardTitle, c as CardDescription, d as CardContent } from './card_8zQAw4wO.mjs';
import './astro/server_DzSu7Vuv.mjs';
import { S as Skeleton } from './skeleton_DwdCzVKQ.mjs';
import { RefreshCw } from 'lucide-react';
import { S as Select, a as SelectTrigger, b as SelectValue, c as SelectContent, d as SelectItem } from './select_L9ivKVNB.mjs';
...
function ChartWidget({
    ...
    if (typeof window !== "undefined" && chartRef.current) {
      import('chart.js').then((ChartJS) => {
        ...
        if (ctx) {
          ...
          const newChart = new ChartJS.Chart(ctx, config);
          setChart(newChart);
        }
      });
    }
  ...
  const rangeSelector = allowRangeSelection ? /* @__PURE__ */ jsxs(
    Select,
    {
      value: range,
      onValueChange: (value) => setRange(value),
      children: [
        /* @__PURE__ */ jsx(SelectTrigger, { className: "w-[100px] h-8 text-xs", children: /* @__PURE__ */ jsx(SelectValue, {}) }),
...
//# sourceMappingURL=ChartWidget_CQbQhHdN.mjs.map
