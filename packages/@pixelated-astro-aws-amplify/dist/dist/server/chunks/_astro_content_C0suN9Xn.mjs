;!function(){try{var e="undefined"!=typeof window?window:"undefined"!=typeof global?global:"undefined"!=typeof globalThis?globalThis:"undefined"!=typeof self?self:{},n=(new e.Error).stack;n&&(e._sentryDebugIds=e._sentryDebugIds||{},e._sentryDebugIds[n]="0c632fdd-6d9d-4bb6-b616-e4fc84bcb3f0",e._sentryDebugIdIdentifier="sentry-dbid-0c632fdd-6d9d-4bb6-b616-e4fc84bcb3f0")}catch(e){}}();import { o as AstroError, at as UnknownContentCollectionError, c as createComponent, au as RenderUndefinedEntryError, ar as unescapeHTML, a as renderTemplate, q as escape, av as renderUniqueStylesheet, aw as renderScriptElement, ax as createHeadAndContent, r as renderComponent } from './astro/server_DzSu7Vuv.mjs';
import { z } from 'zod';
import { b as removeBase, i as isRemotePath, p as prependForwardSlash } from './path_BuLi1_ZZ.mjs';
import { b as VALID_INPUT_FORMATS } from './consts_BUfCLwEr.mjs';
import { u as unflatten } from './parse_gGzV5mHh.mjs';
...
class ImmutableDataStore {
  ...
  static async fromModule() {
    try {
      const data = await import('./_astro_data-layer-content_CVviv8DG.mjs');
...
function createGetCollection({
  ...
  return async function getCollection(collection, filter) {
    ...
    if (collection in contentCollectionToEntryMap) {
      ...
      const { default: imageAssetMap } = await import('./content-assets_OrnwjwW4.mjs');
      const result = [];
...
async function updateImageReferencesInBody(html, fileName) {
  ...
  const { getImage } = await import('./_astro_assets_Ka0KYbgd.mjs').then(n => n._);
...
async function renderEntry(entry) {
  ...
  if (entry.deferredRender) {
    try {
      const { default: contentModules } = await import('./content-modules_B8MoE6Dl.mjs');
...
//# sourceMappingURL=_astro_content_C0suN9Xn.mjs.map
