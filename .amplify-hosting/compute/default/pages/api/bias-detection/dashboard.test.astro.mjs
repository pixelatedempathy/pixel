;!function(){try{var e="undefined"!=typeof window?window:"undefined"!=typeof global?global:"undefined"!=typeof globalThis?globalThis:"undefined"!=typeof self?self:{},n=(new e.Error).stack;n&&(e._sentryDebugIds=e._sentryDebugIds||{},e._sentryDebugIds[n]="82d28735-1e41-4a3b-ba04-8103c01f392d",e._sentryDebugIdIdentifier="sentry-dbid-82d28735-1e41-4a3b-ba04-8103c01f392d")}catch(e){}}();import { B as BiasDetectionEngine } from '../../../chunks/BiasDetectionEngine_BKcjywlG.mjs';
import '../../../chunks/cache_TdBqzGVv.mjs';
import '../../../chunks/astro/server_DBAAVvAL.mjs';
export { renderers } from '../../../renderers.mjs';

vi.mock("@/lib/ai/bias-detection");
vi.mock("@/lib/utils/logger");
const { GET } = await import('../../../chunks/dashboard_BMHFSObB.mjs').then(n => n._);
describe("Bias Detection Dashboard API Endpoint", () => {
  ...
  const mockDashboardData = {
    ...
    alerts: [
      ...
      {
        alertId: "alert-2",
        timestamp: /* @__PURE__ */ new Date("2024-01-15T08:45:00Z"),
        level: "medium",
        type: "medium_bias",
    ...
    trends: [
      ...
      {
        date: /* @__PURE__ */ new Date("2024-01-15T00:00:00Z"),
        biasScore: 0.35,
        sessionCount: 28,
        alertCount: 4,
  ...
  beforeEach(() => {
    ...
    global.Response = vi.fn().mockImplementation((body, init) => {
      ...
      return {
        ...
        headers: {
          get: vi.fn((key) => defaultHeaders.get(key) || null)
        }
      };
    });
    mockBiasEngine = {
  ...
  describe("GET /api/bias-detection/dashboard", () => {
    ...
    it("should handle bias detection engine errors", async () => {
      ...
      global.Response = vi.fn().mockImplementation((body, init) => ({
        ...
        headers: {
          get: vi.fn((_key) => "application/json")
        }
      }));
      const response = await GET({ request });
    ...
    it("should handle network timeout scenarios", async () => {
      mockBiasEngine.getDashboardData.mockImplementation(
        () => new Promise(
          (_, reject) => setTimeout(() => reject(new Error("Request timeout")), 100)
        )
      );
      const request = createMockRequest();
      global.Response = vi.fn().mockImplementation((body, init) => ({
