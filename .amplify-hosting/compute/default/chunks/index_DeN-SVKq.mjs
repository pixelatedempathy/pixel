;!function(){try{var e="undefined"!=typeof window?window:"undefined"!=typeof global?global:"undefined"!=typeof globalThis?globalThis:"undefined"!=typeof self?self:{},n=(new e.Error).stack;n&&(e._sentryDebugIds=e._sentryDebugIds||{},e._sentryDebugIds[n]="0d0ca48f-802c-47b0-a44a-1e3f43402476",e._sentryDebugIdIdentifier="sentry-dbid-0d0ca48f-802c-47b0-a44a-1e3f43402476")}catch(e){}}();import { a as getHipaaCompliantLogger, c as getClinicalAnalysisLogger, d as getAiServiceLogger } from './standardized-logger_DzhAW4ic.mjs';
import { config, getEnv } from './env.config_C7r7Q_W6.mjs';
...
class MentalLLaMAAdapter {
  ...
  constructor(options) {
    ...
    try {
      this.crisisSessionFlaggingServiceImport = import('./CrisisSessionFlaggingService_BRvaXYFO.mjs');
    } catch (_e) {
      logger$2.warn(
...
async function createMentalLLaMAPythonBridge(scriptPath) {
  if (typeof process !== "undefined" && process.versions?.node && typeof window === "undefined") {
    try {
      ...
      const { MentalLLaMAPythonBridge } = await import('./browser-stub_De-PzSuy.mjs');
