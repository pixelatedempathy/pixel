...
import { l as logAuditEvent, A as AuditEventType } from './audit_Dj-29q3L.mjs';
import { d as dlpService } from './dlp_DpQDdvYf.mjs';
...
async function getStorageProvider(provider, config = {}) {
  try {
    const { getStorageProvider: importedGetStorageProvider } = await import('./storage-providers-wrapper_7Vcywo6i.mjs');
