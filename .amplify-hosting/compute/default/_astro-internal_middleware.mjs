;!function(){try{var e="undefined"!=typeof window?window:"undefined"!=typeof global?global:"undefined"!=typeof globalThis?globalThis:"undefined"!=typeof self?self:{},n=(new e.Error).stack;n&&(e._sentryDebugIds=e._sentryDebugIds||{},e._sentryDebugIds[n]="572eec6b-ef71-43aa-8da1-af45b74d35f7",e._sentryDebugIdIdentifier="sentry-dbid-572eec6b-ef71-43aa-8da1-af45b74d35f7")}catch(e){}}();import { webcrypto } from 'node:crypto';
import { d as distExports } from './chunks/astro-designed-error-pages_qhq3DYJx.mjs';
import { randomBytes } from 'crypto';
import './chunks/astro/server_DBAAVvAL.mjs';
import 'clsx';
import { s as sequence } from './chunks/index_fIkZh-tO.mjs';
...
function getContextEnvVar(envVarName, contextOrLocals) {
  ...
  return Object.assign(__vite_import_meta_env__, { CLERK_SECRET_KEY: "sk_live_amge3Dv5RSu3qozsCBVgY3F6hI6ibRFIIZUZBHihnH", BROWSER: process.env.BROWSER, _: process.env._ })[envVarName];
}
...
var createClerkClientWithOptions = (context, options) => createClerkClient({
  ...
  userAgent: `${"@clerk/astro"}@${"2.10.8"}`,
  sdkMetadata: {
    name: "@clerk/astro",
    version: "2.10.8",
    // eslint-disable-next-line turbo/no-undeclared-env-vars
    environment: Object.assign(__vite_import_meta_env__, { CLERK_SECRET_KEY: "sk_live_amge3Dv5RSu3qozsCBVgY3F6hI6ibRFIIZUZBHihnH", BROWSER: process.env.BROWSER, _: process.env._ }).MODE
  },
  telemetry: {
...
var createGetAuth = ({ noAuthStatusMessage }) => {
  return (req, locals, { treatPendingAsSignedOut = true, ...opts } = {}) => {
    ...
    return getAuthObjectFromJwt(decodeJwt2(authToken), { ...options, treatPendingAsSignedOut });
  };
};
 ...
 */
async function generateCspNonce({ locals }, next) {
...
const onRequest$1 = sequence(generateCspNonce, clerkAuthMiddleware)
