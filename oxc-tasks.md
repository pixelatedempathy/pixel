...
- [ ] `src/lib/fhe/examples/parameter-optimization-example.ts:54:33`: Unexpected any. Specify a different type.
- [ ] `src/lib/fhe/examples/parameter-optimization-example.ts:99:33`: Unexpected any. Specify a different type.
